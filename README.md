...
```gradle
testCompile 'org.testfx:openjfx-monocle:26.0.2' // For OpenJFX 26
...
<dependency>
    ...
    <version>26.0.2</version> <!-- 21.0.2 For OpenJFX 21, 17.0.10 For OpenJFX 17, 11.0.2 For OpenJFX 11, jdk-8.0.372 for Java 8 -->
    <scope>test</scope>
</dependency>
```
...
See `src/docs/source-code.md` for details.
